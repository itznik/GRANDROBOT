...
TECHNO_IMG = "https://telegra.ph/file/b53a6ce1358c2da9cfbad.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/itznik_x")],
                                                                                   [InlineKeyboardButton(text="ADD 𝐑𝐀𝐕𝐀𝐍 TO YOUR GROUP",
        ...
        update.effective_message.reply_text("Zinda hu lawde..🙈")
